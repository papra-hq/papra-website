---
title: "Introducing Cadence-MQ: a backend-agnostic NodeJs job queue"
description: Introducing Cadence-MQ, a backend-agnostic NodeJs job queue built for self-hosted applications and high-performance workloads.
...
I recently released [Cadence-MQ](https://github.com/papra-hq/cadence-mq), a backend-agnostic NodeJs job queue built with self-hosting in mind.
