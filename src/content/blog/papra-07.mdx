...
We've added the `APP_BASE_URL` environment variable to simplify the configuration of Papra, when set, it'll overrive the `SERVER_BASE_URL` and `CLIENT_BASE_URL` environment variables.
